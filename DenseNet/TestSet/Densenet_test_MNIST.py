...
"""
file: Densenet_test_MNIST.py
CSCI-631:  COMPUTER VISION
Author: Rajkumar Lenin Pillai


Description:This program uses the  denset model trained on MNIST dataset
...
##Downloading the MNIST test_set
testset = torchvision.datasets.MNIST(root='./data-MNIST', train=False, download=True, transform=data_transform)
...
if __name__ == '__main__':
    ...
    net.load_state_dict(torch.load('densenet_model_weights_MNIST'))
    ...
    img = pngimg.imread('model_loss_MNIST.png')
    plt.imshow(img)
    plt.show()
