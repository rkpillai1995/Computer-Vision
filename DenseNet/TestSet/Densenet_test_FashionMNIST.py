...
"""
file: Densenet_test_FashionMNIST.py
CSCI-631:  COMPUTER VISION
Author: Rajkumar Lenin Pillai


Description:This program uses the  denset model trained on Fashion-MNIST dataset
...
##Downloading the Fashion-MNIST test_set
...
if __name__ == '__main__':
    ...
    net.load_state_dict(torch.load('densenet_model_weights_FashionMNIST'))
    ...
    img = pngimg.imread('model_loss_Fashion-MNIST.png')
    plt.imshow(img)
    plt.show()
