...
"""
file: Densenet_train_MNIST.py
CSCI-631:  COMPUTER VISION
Author: Rajkumar Lenin Pillai


Description:This program creates a Dense neural network and is trained on MNIST dataset
...
data_transform = transforms.Compose(
     [
        transforms.Resize(96),  ### Resizing image dimenesion to 224x224
        transforms.ToTensor()
     ])
...
trainset = torchvision.datasets.FashionMNIST(root='./data-MNIST', train=True, download=True, transform=data_transform)

# Loading the training set
trainloader = torch.utils.data.DataLoader(trainset, batch_size=32, shuffle=True, num_workers=0)

testset = torchvision.datasets.FashionMNIST(root='./data-MNIST', train=False, download=True, transform=data_transform)
...
if __name__ == '__main__':
    ...
    torch.save(net.state_dict(), 'densenet_model_weights_MNIST')
    ...
    def ploting(saved_losses_train):
            ...
            fig.savefig('model_loss_MNIST.png')
            plt.legend()
            plt.show(fig)
