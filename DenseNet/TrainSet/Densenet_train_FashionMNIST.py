...
"""
file: Densenet_train_FashionMNIST.py
CSCI-631:  COMPUTER VISION
Author: Rajkumar Lenin Pillai


Description:This program creates a Dense neural network and is trained on Fashion-MNIST dataset
...
trainset = torchvision.datasets.FashionMNIST(root='./data-fashion-MNIST', train=True, download=True, transform=data_transform)

# Loading the training set
trainloader = torch.utils.data.DataLoader(trainset, batch_size=32, shuffle=True, num_workers=0)

testset = torchvision.datasets.FashionMNIST(root='./data-fashion-MNIST', train=False, download=True, transform=data_transform)
...
if __name__ == '__main__':
    ...
    def ploting(saved_losses_train):
            ...
            fig.savefig('model_loss_FashionMNIST.png')
            plt.legend()
            plt.show(fig)
