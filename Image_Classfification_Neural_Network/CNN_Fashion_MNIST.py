...
Description:This program creates a covonutional neural network and is trained on Fashion-MNIST dataset
...
if __name__ == '__main__':
    ...
    class Net(nn.Module):
        '''
        This class is used to define the nueral network
        '''
        def __init__(self):
    ...
    saved_losses_train,saved_losses_validation,overfitting_epoch_train,overfitting_epoch_val=train(trainloader,validationloader)
    ...
    for i in range(10):
             print('Accuracy of %5s : %2d %%' % (
                 classes[i], 100 * class_correct[i] / class_total[i]) , " Incorrect samples ",int(class_incorrect[i] ), " correct samples ", int(class_correct[i]))
    ...
    plt.savefig('Accuracies_of_all_classes.png')
    plt.show()
    ...
    plt.savefig('Plot_of_Accuracy_of_class_0.png')
    plt.show()
    ...
    plt.savefig('Plot_of_Accuracy_of_class_1.png')
    plt.show()
    ...
    plt.savefig('Plot_of_Accuracy_of_class_2.png')
    plt.show()
    ...
    plt.savefig('Plot_of_Accuracy_of_class_3.png')
    plt.show()
    ...
    plt.savefig('Plot_of_Accuracy_of_class_4.png')
    plt.show()
    ...
    plt.savefig('Plot_of_Accuracy_of_class_5.png')
    plt.show()
    ...
    plt.savefig('Plot_of_Accuracy_of_class_6.png')
    plt.show()
    ...
    plt.savefig('Plot_of_Accuracy_of_class_7.png')
    plt.show()
    ...
    plt.savefig('Plot_of_Accuracy_of_class_8.png')
    plt.show()
    ...
    plt.savefig('Plot_of_Accuracy_of_class_9.png')
    plt.show()
